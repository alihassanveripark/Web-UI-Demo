...
WebUI.waitForElementVisible(findTestObject('xLogin_CRM/Txt_UserName'), 0)
...
WebUI.waitForElementVisible(findTestObject('xLogin_CRM/Txt_Password'), 0)
...
WebUI.waitForElementVisible(findTestObject('xLogin_CRM/Btn_PopUpYes'), 0)
